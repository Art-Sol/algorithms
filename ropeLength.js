 ...
 * лежащих на столе верёвочек. По длинам оставшихся на столе N верёвочек определите, какую
...
const ropeLength = (n, arr) => {
  ...
  return max - sum > 0 ? max - sum : max + sum;
};

console.log(ropeLength(4, [1, 5, 2, 1])); // 1
console.log(ropeLength(4, [5, 12, 4, 3])); // 24
